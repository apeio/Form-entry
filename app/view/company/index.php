      ...
      <div class="row">
          <div class="col-lg-12">
            ...
            <div id="flameTop"
                ...
                <iframe <?= $objTop ?> <?= $wh100 ?> src="<?= BASE_URL ?>/company/top">></iframe>
            </div>
                      <hr/>
                <div id="flameBottom"
                     class="w100 mgnT0 "
                    ...
                    <iframe <?= $objBtm ?> <?= $wh100 ?> src="<?= BASE_URL ?>/company/bottom"></iframe>
                </div>
                <div id="flameBotton" class="w100 mgnT0 mgnT5" style="height:<?= $BtnH ?>%;">
                    <iframe <?= $objBtn ?> <?= $wh100 ?>    src="<?= BASE_URL ?>/company/button"></iframe>
                </div>
                      </div>
                  </div>
          </div>
...
<script type="text/javascript">
        function callBottom(B010UserCd) {
            ...
            top.objButton.location.href = baseUrl + '/company/bottom?B010CompanyCd=' + B010UserCd;
        }
    </script>
